...
import com.sinosoft.cms.base.enums.BusinessStatus;
...
public class LogAspect {
    ...
    // 配置织入点
    @Pointcut("@annotation(com.sinosoft.cms.base.annotation.Log)")
    ...
    public boolean isFilterObject(final Object o) {
        ...
        if (clazz.isArray()) {
            ...
            for (Iterator iter = collection.iterator(); iter.hasNext(); ) {
                if (iter.next() instanceof MultipartFile) {
                    bool = iter.next() instanceof MultipartFile;
                    break;
                }
            }
            return bool;
            ...
            for (Iterator iter = map.entrySet().iterator(); iter.hasNext(); ) {
                ...
                if (entry.getValue() instanceof MultipartFile)  {
                    bool = entry.getValue() instanceof MultipartFile;
                    break;
                }
            }
            return bool;
