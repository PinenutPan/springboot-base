...
import com.sinosoft.cms.base.exception.PreAuthorizeException;
...
public class PreAuthorizeAspect {
     ...
     * 管理员角色权限标识
     */
    private static final String SUPER_ADMIN = "manager";
    ...
    @Around("@annotation(com.sinosoft.cms.base.annotation.PreAuthorize)")
