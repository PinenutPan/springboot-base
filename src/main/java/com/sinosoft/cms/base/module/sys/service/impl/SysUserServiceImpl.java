...
import com.sinosoft.cms.base.exception.CustomException;
import com.sinosoft.cms.base.module.sys.domain.SysRole;
import com.sinosoft.cms.base.module.sys.domain.SysUser;
import com.sinosoft.cms.base.module.sys.domain.SysUserRole;
import com.sinosoft.cms.base.module.sys.mapper.SysRoleMapper;
import com.sinosoft.cms.base.module.sys.mapper.SysUserMapper;
import com.sinosoft.cms.base.module.sys.mapper.SysUserRoleMapper;
...
public class SysUserServiceImpl implements ISysUserService {
    ...
    public void checkUserAllowed(SysUser user) {
        ...
        if (StringUtils.isNotNull(user.getUserId()) && this.isAdmin(user.getUserId()) && "admin".equals(sysUser.getUserName())) {
    ...
    @Override
    public boolean updateUserBackground(String userName, String background) {
        return userMapper.updateUserBackground(userName, background) > 0;
    }
    ...
    @Override
    public List<SysUser> selectAuthUser(Long userId) {
        return userMapper.selectAuthUser(userId);
    }
