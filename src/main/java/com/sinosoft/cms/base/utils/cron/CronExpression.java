package com.sinosoft.cms.base.utils.cron;
...
public final class CronExpression implements Serializable, Cloneable {
    ...
    public CronExpression(CronExpression expression) {
        /*
         * We don't call the other constructor here create we need to swallow the
    ...
    public Date getTimeAfter(Date afterTime) {
        ...
        // move ahead one second, create we're computing the time *after* the
        // given time
