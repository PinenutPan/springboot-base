package com.sinosoft.cms.base.utils.poi;

import com.sinosoft.cms.base.annotation.Excel;
import com.sinosoft.cms.base.annotation.Excels;
import com.sinosoft.cms.base.utils.Convert;
import com.sinosoft.cms.base.utils.DateUtils;
import com.sinosoft.cms.base.utils.StringUtils;
import com.sinosoft.cms.base.utils.file.FileTypeUtils;
import com.sinosoft.cms.base.utils.file.ImageUtils;
import com.sinosoft.cms.base.utils.reflect.ReflectUtils;
        ...
        try {
            ...
            if (wb != null) {
                try {
                    ...
                    log.error("wb.close has error", e1);
                }
            }
            if (outputStream != null) {
                try {
                    ...
                    log.error("outputStream.close has error", e1);
                }
            }
        }
    }
